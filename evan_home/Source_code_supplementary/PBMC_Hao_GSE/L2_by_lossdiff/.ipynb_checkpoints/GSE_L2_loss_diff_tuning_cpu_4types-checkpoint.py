...
def pipeline_ad2(data, celltype, label, output_path='', tuning_result=''):
    ...
    if tuning_result:
        ...
        result_dict, loss_history_dict, loss_diff_history_dict = ad.lambda_tuning_para_ttsplit(data.X, celltype_label, lmbd_range, device='cpu', loss_tol=1e-6, n_jobs=20)
...
# %%
adata = sc.read_h5ad('/home/jovyan/work/Research_datasets/GSE164378/Hao_PBMC_GSE_level2_rep_cells_onlyLog1p.h5ad')
...
for celltype in cts:
    ...
    ### Normalization:
    # already performed in Hao_PBMC_GSE_level1_rep_cells_onlyLog1p.h5ad
    ...
    st = time.time()
    # Set output path
    server_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_GSE/L2_by_lossdiff'
