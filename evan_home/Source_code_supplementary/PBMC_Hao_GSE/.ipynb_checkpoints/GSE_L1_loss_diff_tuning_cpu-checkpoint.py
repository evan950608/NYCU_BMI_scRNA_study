...
def pipeline_ad2(data, celltype, label, output_path='', tuning_result=''):
    ...
    if tuning_result:
        ...
        result_dict, loss_history_dict, loss_diff_history_dict = ad.lambda_tuning_para_ttsplit(data.X, celltype_label, lmbd_range, device='cpu', loss_tol=1e-6, n_jobs=25, max_iter=5)
