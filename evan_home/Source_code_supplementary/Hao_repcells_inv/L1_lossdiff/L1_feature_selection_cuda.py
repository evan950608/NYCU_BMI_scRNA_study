...
def pipeline_feature_selection(data, celltype, label, opt_lmbd, output_path=''):
    ...
    with open(f'{celltype}_AD_model.pkl', 'wb') as f:
...
def run_pipeline_feature_selection(celltype):
    st = time.time()
    # Read adata
    adata = sc.read_h5ad('/home/jovyan/work/Research_datasets/GSE164378/Hao_level1_inv_rep_cells.h5ad')
    print('Original adata:', adata.shape)  # (77763, 33538)
    ...
    path_opt_lambda = '/home/jovyan/work/GitHub/EvanPys/Progress/Hao_repcells_inv/L1_lossdiff/L1_loss_diff_opt_lmbd.json'
    ...
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/Hao_repcells_inv/L1_lossdiff'
    local_path = ''
