...
def run_pipeline_feature_selection(celltype):
    ...
    # work/GitHub/EvanPys/Progress/Stuart_bm/Level1_onlylog1p/L1_loss_diff_opt_lmbd_log1p.json
    path_opt_lambda = '/home/jovyan/work/GitHub/EvanPys/Progress/Stuart_bm/Level1_onlylog1p/L1_loss_diff_opt_lmbd_log1p.json'
    ...
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/Stuart_bm/Level1_onlylog1p'
    local_path = ''
