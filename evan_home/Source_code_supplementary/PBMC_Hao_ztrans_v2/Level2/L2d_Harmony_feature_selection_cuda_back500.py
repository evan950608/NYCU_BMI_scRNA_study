...
def pipeline_feature_selection(data, X_raw_count, celltype, label, opt_lmbd, output_path=''):
    print('====================')
    ...
    pvl = ad.get_prevalence(X_raw_count, celltype_indices)
...
def run_pipeline_feature_selection(celltype, raw_adata):
    st = time.time()
    # Read adata
    adata = sc.read_h5ad('/home/jovyan/work/Research_datasets/PBMC_Hao/GSE164378_Hao/Harmony_and_ztrans/Hao_L2_repcells_loginv_Harmony_ztrans_afterrep.h5ad')
    ...
    path_opt_lambda = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_ztrans_v2/Level2/L2c_opt_lmbd_back500_final.json'
    ...
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_ztrans_v2/Level2/feature_selection'
    local_path = ''
    pipeline_feature_selection(adata, raw_adata.X, celltype, label, opt_lmbd, output_path=server_fractal_path)
...
for celltype in queue:
    run_pipeline_feature_selection(celltype, raw_count_adata_subset)
