...
# -------------------------------------
# DATA_DIR <- "/Users/evanli/Documents/Research_datasets/PBMC_68k_Zheng/github_data"        # SPECIFY HERE
DATA_DIR = 'C:/Users/evanlee/Documents/Research_datasets/PBMC_68k_Zheng/github_data'
# PROG_DIR <- "/Users/evanli/Documents/Research_datasets/PBMC_68k_Zheng/github_data"     # SPECIFY HERE
PROG_DIR = 'C:/Users/evanlee/Documents/Research_datasets/PBMC_68k_Zheng/github_data'
RES_DIR  <- "C:/Users/evanlee/Documents/GitHub/EvanPys/Progress/PBMC_Zheng/paper_main_process/result_dir"      # SPECIFY HERE
...
# --------------------------------------------
set.seed(0)
# Subsetting the top 1000 variable genes
...
ggplot(tdf_mod_2,aes(X1,X2,col=cls_id))+geom_point(size=0,alpha=1)+theme_classic()+.set_pbmc_color_11() +
    guides(col = guide_legend(override.aes = list(size=4)))  # Adjust size here
# --------------------------------------------------
