...
for cluster in queue:
    ...
    st = time.time()
    # Set output path
    server_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Zheng/Leiden_HVG_PreLect'

    # set learning rate alpha to 0.01
    pipeline_ad2(ad_X_sparse, cluster, label_leiden, output_path=server_path)
    et = time.time()
    print('{} Time elapsed: {} minutes.'.format(cluster, (et-st)/60))
    del adata
