...
adata = sc.read('/home/evanlee/PBMC_Hao/Hao_PBMC_level2_rep_cells.h5ad')
print(adata.shape)  # (32340, 20568)
...
for celltype in cts:
    ...
    pipeline_ad2(adata, celltype, label, alpha=0.001, output_path='/home/evanlee/PBMC_Hao/Level_2_alpha0.001/Level2_alpha0.001_result')
    et = time.time()
...
def run_pipeline_feature_selection(celltype):
    # read optimal lambda
    os.chdir('/home/evanlee/PBMC_Hao/Level_2_alpha0.001/Level2_alpha0.001_result')
    with open(f'./{celltype}_opt_lambda.txt', 'r') as f:
        opt_lmbd = float(f.read())
    print(celltype, 'Optimal lambda:', opt_lmbd, '\n')

    # set learning rate alpha to 0.001
    pipeline_feature_selection(adata, celltype, label, opt_lmbd, alpha=0.001, output_path='/home/evanlee/PBMC_Hao/Level_2_alpha0.001/Level2_alpha0.001_result')
