...
def run_tuning(adata, cts, label):
    for celltype in [cts]:
        ...
        server_path = '/home/evanlee/PBMC_Hao/Level_1_alpha0.01/Level1_result'
...
def run_pipeline_feature_selection(celltype):
    ...
    # set learning rate alpha to 0.001
    pipeline_feature_selection(adata, celltype, label, opt_lmbd, alpha=0.01, output_path='/home/evanlee/PBMC_Hao/Level_1_alpha0.01/Level1_result')
