...
def pipeline_ad2(data, celltype, label, output_path='', tuning_result=''):
    ...
    if tuning_result:
        ...
        result_dict, loss_history_dict = ad.lambda_tuning_cuda(data.X, celltype_label, lmbd_range, device='cuda', loss_tol=1e-6)
...
for celltype in types:
    ...
    st = time.time()
    # Set output path
    server_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao/Level1_loss_difference'
