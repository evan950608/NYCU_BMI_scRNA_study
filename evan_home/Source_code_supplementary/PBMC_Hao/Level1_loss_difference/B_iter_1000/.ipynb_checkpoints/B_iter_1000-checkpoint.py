...
def run_pipeline_feature_selection(celltype):
    ...
    opt_lmbd = 0.006812920690579613
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao/Level1_loss_difference/B_iter_1000'
...
# %% Main code
run_pipeline_feature_selection('B')
