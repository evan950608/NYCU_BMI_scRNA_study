...
def pipeline_ad2(data, celltype, label, alpha, output_path='', tuning_result=''):
    ...
    if tuning_result:
        ...
        # Lambda tuning
        # result_dict = ad.lambda_tuning_para_ttsplit(data.X, celltype_label, lmbd_range, alpha=alpha, device='cuda', n_jobs=25)
        # CUDA version
...
server_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao/Level2_loss_converge'
