...
def pipeline_feature_selection(data, celltype, label, opt_lmbd, output_path=''):
    ...
    opt_res = ad.ADlasso2(lmbd=opt_lmbd, echo=True, device='cpu')  # cuda
...
def run_pipeline_feature_selection(celltype):
    ...
    with open('/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao/Remove_pvl0_v3_ttsplit/lambda_decision_new/v3_lambda_decision_new.json', 'r') as f:
        opt_lambda_dict = json.load(f)
    opt_lmbd = opt_lambda_dict[celltype]


    pipeline_feature_selection(adata, celltype, label, opt_lmbd, output_path='/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao/Remove_pvl0_v3_ttsplit')
