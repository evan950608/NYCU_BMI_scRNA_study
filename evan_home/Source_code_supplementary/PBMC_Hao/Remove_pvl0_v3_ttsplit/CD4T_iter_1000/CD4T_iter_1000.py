...
def pipeline_feature_selection(data, celltype, label, opt_lmbd, output_path=''):
    ...
    # Set weight_difference_tol to 1e-4
    opt_res = ad.ADlasso2(lmbd=opt_lmbd, tol=1e-4, echo=True, device='cuda')  # cuda
    ...
    weight_diff_history = opt_res.weight_diff_history
    # print('weight_diff_history:', weight_diff_history)
    with open(f'{celltype}_weight_diff_history.json', 'w') as f:
        json.dump(weight_diff_history, f)
...
def run_pipeline_feature_selection(celltype):
    ...
    opt_lmbd = 0.014677992676220709  # or 0.01
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao/Remove_pvl0_v3_ttsplit/CD4T_iter_1000'
