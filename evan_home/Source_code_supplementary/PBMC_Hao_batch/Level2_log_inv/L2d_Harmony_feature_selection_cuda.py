...
def run_pipeline_feature_selection(celltype):
    ...
    path_opt_lambda = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch/Level2_log_inv/opt_lambda_json/L2_Harmony_opt_lmbd_v3.json'
    ...
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch/Level2_log_inv/feature_selection_v3'
    local_path = ''
...
# RCT = ['ILC', 'CD4_Proliferating', 'CD8_Proliferating', 'Eryth', 'ASDC']
