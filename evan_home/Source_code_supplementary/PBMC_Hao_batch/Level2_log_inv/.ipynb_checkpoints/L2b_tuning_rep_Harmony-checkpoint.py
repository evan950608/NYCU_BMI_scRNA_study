...
def pipeline_ad2(X_norm, celltype, label, output_path='', tuning_result=''):
    ...
    if tuning_result:
        ...
        result_dict, loss_history_dict, loss_diff_history_dict = ad.lambda_tuning_para_ttsplit(X_norm, celltype_label, lmbd_range, device='cpu', loss_tol=1e-6, n_jobs=25, max_iter=10)
...
for celltype in queue:
    ...
    st = time.time()
    # Set output path
    server_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch/Level2_log_inv/tuning_result'
