...
def run_pipeline_feature_selection_at_lambda(celltype, set_lambda):
    ...
    # server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch_noZ/Level2/large_lambda_various/at_various_number/added_features_at_various_no'
    server_fractal_path = source_code_dir / 'PBMC_Hao_batch_noZ/Level2/large_lambda_various/at_various_number/added_features_at_various_no'
...
queue_filtered = ['B_memory',
                  'B_naive',  # previous result single
                    ...
                    'gdT',
                    'pDC']
print('queue_filtered', queue_filtered)
...
for celltype, indices in new_idx_dict.items():
    # tuning_filename = os.path.join('/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch_noZ/Level2/tuning_result', f'{celltype}_tuning.json')
    tuning_filename = os.path.join(source_code_dir, 'PBMC_Hao_batch_noZ/Level2/tuning_result', f'{celltype}_tuning.json')
...
for celltype in queue_filtered:
    try:
