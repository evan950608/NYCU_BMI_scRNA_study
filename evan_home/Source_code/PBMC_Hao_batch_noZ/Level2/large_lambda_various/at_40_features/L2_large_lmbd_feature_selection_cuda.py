...
def run_pipeline_feature_selection(celltype):
    ...
    path_opt_lambda = source_code_dir / 'PBMC_Hao_batch_noZ/Level2/large_lambda_various/at_40_features/L2_lambda_at_40_features.json'
    ...
    # server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch_noZ/Level2/large_lambda'
    server_fractal_path = source_code_dir / 'PBMC_Hao_batch_noZ/Level2/large_lambda'
...
queue = ['CD8_Proliferating', 'CD8_TEM']
print('Queue', queue)
# print('force stop')
# sys.exit()
