...
def run_pipeline_feature_selection(celltype):
    ...
    path_opt_lambda = source_code_dir / 'PBMC_Hao_batch_noZ/Level1/L1c_k3_opt_lmbd.json'
    ...
    server_fractal_path = '/home/jovyan/work/GitHub/EvanPys/Progress/PBMC_Hao_batch_noZ/Level1/feature_selection_k3_2nd'
    server_fractal_path = source_code_dir / 'PBMC_Hao_batch_noZ/Level1/feature_selection_k3_2nd'
