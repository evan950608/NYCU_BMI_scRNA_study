...
def run_pipeline_feature_selection(celltype):
    ...
    path_opt_lambda = source_code_dir / 'PBMC_Hao_batch_noZ/Level1/large_lambda_various/at_40_features/L1_lambda_at_40_features.json'
    ...
    server_fractal_path = source_code_dir / 'PBMC_Hao_batch_noZ/Level1/large_lambda'
