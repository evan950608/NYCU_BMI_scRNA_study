...
# AD2 20230728
class ADlasso2():
    def __init__(self, lmbd=1e-5, max_iter=100, tol=1e-4, alpha=0.1, gamma=0.1, device='cpu', echo=True):
        super().__init__()
        self.lmbd = lmbd
    ...
    def backtracking(self, X, y, curr_w, p, lr, eta, curr_loss, neg_pseudo_grad, thres, decay=0.95, maxiter=500):
