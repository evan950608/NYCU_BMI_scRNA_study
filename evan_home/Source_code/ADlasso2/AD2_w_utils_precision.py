...
def lambda_tuning_parallel(X_norm, Y, lmbdrange, device='cpu', training_echo=False,
    ...
    def test_lambda(lambd):
        ...
        return (percentage, prevalence_, train_prevalence, train_prevalence_global, feature_number, auc, aupr, mcc, precision, f1, loss_history, error_history)
    ...
    for i, result in enumerate(results):
        ...
        metrics_dict['F1 score'][i] = result[9]
        metrics_dict['loss_history'][i] = result[10]
        metrics_dict['error_history'][i] = result[11]
