...
def run_pipeline_feature_selection(celltype):
    ...
    path_opt_lambda = source_code_dir / 'HCC_case_study/tuning_celltype/c_celltype_k3_opt_lmbd.json'
    ...
    server_fractal_path = source_code_dir / 'HCC_case_study/tuning_celltype'
